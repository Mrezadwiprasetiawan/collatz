...
class ArrowPlotWidget : public QOpenGLWidget, protected QOpenGLFunctions {
 ...
 public:
  explicit ArrowPlotWidget(QWidget* parent = nullptr) : QOpenGLWidget(parent) {}
 ...
 private:
  ...
  QMatrix4x4 mvp() const {
    ...
    view.lookAt({cx + panX_, cy + panY_, cz},  // eye
  ...
  void upload(QOpenGLVertexArrayObject& vao, QOpenGLBuffer& vbo, const std::vector<float>& data, GLsizei& count) {
